      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 bg-[#f5f6f8] flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-scroll">
            {activeTab === "analytics" ? (
              <AnalyticsTab slug={slug} linkLabels={{...Object.fromEntries(links.map((l) => [l.id, l.label])), "kakaotalk-chat": "카톡 문의"}} linkUrls={{...Object.fromEntries(links.map((l) => [l.id, l.url])), "kakaotalk-chat": links.find(l => l.layout === "kakaotalk")?.url || ""}} socialUrls={Object.fromEntries(socials.map((s) => [s.platform, s.url]))} />
